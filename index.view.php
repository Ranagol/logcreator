...
<body>
    <div class="container mt-5 mb-4">
        ...
        <p class="card p-2">This is a very basic log creator. Whenever you click on whichever button, the app will create a log of that event. Example: if you click on button 'A', a new log will be created in the log.txt file: '[time; date] A button is clicked'. So, check the log.txt after the click...</p>
